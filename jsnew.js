let posts = [
 ...
 function deletePost(id) {
        if (posts.findIndex(post=>post.id === id) !== -1) {
            posts.splice(posts.findIndex(post=>post.id === id), posts.findIndex(post=>post.id === id)+1);
            return true;
        }
        return false;
    }
...
console.log(validatePost({id: '124', createdAt: new Date(),  description: 'Hello', author:'Its me', hashTags: ['i was wondering'],likes: ["ME"]}));
console.log("Check validating without param");
console.log(validatePost({ createdAt: new Date(),author:'Its me', hashTags: ['i was wondering']}));
